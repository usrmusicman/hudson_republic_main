...
3. **Residency**: The individual must have maintained continuous residency within the specific Riding in which they intend to vote for a minimum of one (1) full year immediately preceding the date the election is called.  
4. **Legal Standing**:  
...
## Section 2 — Accommodations for Transitional and Unhoused Citizens
Citizens experiencing housing transitions or lacking a current fixed address retain the right to vote subject to the following protocols:

1. **Default Riding of Record**: Such citizens shall cast their ballot in the Riding in which they attained the Age of Majority, or in the Riding of their most recent verified address (provided that address was held for a minimum of one (1) continuous year).  
2. **Address Update Mandate**: Upon securing a new address, the citizen must immediately file an “Address Update Request” with Hudson Elections. The one-year residency requirement for the new Riding begins on the official submission date of this request, not the date of physical relocation.  
3. **Unhoused Provisions**: Unhoused citizens shall vote in the Riding of their last verified address. Alternatively, citizens who have resided continuously for at least one (1) year in a recognized subsidized co-op housing facility within the current Riding may vote in that Riding.

---

## Section 3 — Ineligible Persons
The following categories of persons are expressly barred from voting in any election or bi-election:
