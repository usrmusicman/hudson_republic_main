...
2. **Address Update Mandate**: Upon securing a new address, the citizen must immediately file an “Address Update Request” with Hudson Elections. The one-year residency requirement for the new Riding begins on the official submission date of this request.  
