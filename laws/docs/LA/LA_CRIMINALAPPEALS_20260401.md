# Criminal Appeals and Procedures Act
...
- **Judgment Redemption Note (JRN)**: A formal judicial note detailing reformation progress, signed by the judge, witnesses, and offender.  
...
Appeals operate on a three-strike model:  
- Appeal 1 (Local Court): Filed in the Riding Court.  
- Appeal 2 (Superior Court): Filed in the Superior Court.  
- Appeal 3 (Supreme Court): Filed only on constitutional grounds or legislative ambiguity; leads to a final retrial in Superior Court if granted.
...
## Section 4 — Mistrials
A mistrial may be declared for juror misconduct, newly discovered exculpatory evidence, or procedural irregularities. The case may be retried at the same court level (or moved to another location). A mistrial does not count against the defendant’s three appeals. The defendant incurs no additional fees beyond the original appeal filing fee.

---

## Section 5 — Right to a Speedy Trial
If an individual is held in custody without conviction for longer than the following periods, they shall be automatically released and may sue for damages:  

- **Level 1–3 offenses** (misdemeanors): 12 months  
- **Level 4–7 offenses** (felonies): 24 months  
- **Level 8–9 offenses** (capital offenses): 30 months  

The 30-month maximum may be extended only by order of the Superior Court if:  
...
## Section 6 — Botched Executions
If an execution is botched, the sentence is automatically commuted to natural life imprisonment.

---

## Section 7 — Serving Terms
All sentences must be served in full (100% time served). No early release for good behavior is permitted unless the conviction is overturned on appeal.

---

## Section 8 — Witness Incarceration Protection Services (WIPS)
This program is available only to informants. High-risk convicts (e.g., gang leaders, sex offenders, mass murderers) are not eligible unless they are active informants. All other convicts serve in general population unless they pose a danger to themselves or others.
