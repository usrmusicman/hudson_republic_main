...
- **Threshold**: Unanimous vote/verdict as defined in the **[Clarity Act](./CA_CLARITYACT_20260522.md)** across **three separate readings** in both the House of Constituents and the Senate.  
...
- **Threshold**: Overwhelming Majority vote/verdict as defined in the **[Clarity Act](./CA_CLARITYACT_20260522.md)** across **three separate readings** in both the House of Constituents and the Senate.  
...
### CULT — Cultural Items
- **Philosophy**: Formal expressions of national identity, symbols, heritage, and values. Cultural Items have the same legal weight as a Foundational Constitutional Article (CA(F)).
- **Enactment**: Cultural Items are introduced via a republic-wide citizen referendum and must meet an overwhelming majority mandate as defined in the **[Clarity Act](./CA_CLARITYACT_20260522.md)**, following the same procedural paths as a Foundational Constitutional Article.
- **Dependency Scope**: Cultural Items are strictly isolated assets; they cannot depend on each other, nor can they carry dependencies on any other legislative instrument.
- **Modification**: Cultural Items can only be amended or removed via a republic-wide overwhelming majority citizen referendum as defined in the **[Clarity Act](./CA_CLARITYACT_20260522.md)**, followed by filing a formal Legislative Challenge (LC) in the Supreme Court. The Senate must then conduct three distinct readings to pass the amendment or decommissioning.
...
- **Expiry**: Automatic cessation upon end of emergency. Extensions require a unanimous Senate verdict.
...
### 2.3 Legislative Dependency Matrix
...
All supporting image assets (diagrams, dependency trees, charts, illustrations, etc.) for a specific instrument shall be stored in a dedicated subdirectory using the instrument’s full **FQLN** as the folder name. Individual image files may use any descriptive name, but best practice is to prefix the filename with the full **FQLN** followed by an underscore:
`[root]/laws/images/[INSTRUMENT_TYPE]/[INSTRUMENT_FQLN]/[FILENAME]`

### 3.3 Associated Attachment Assets
All supporting attachment assets (spreadsheets, pdfs, project source files, presentation files, etc.) for a specific instrument shall be stored in a dedicated subdirectory using the instrument’s full **FQLN** as the folder name. Individual attachment files may use any descriptive name, but best practice is to prefix the filename with the full **FQLN** followed by an underscore:
...
**EX1.1 — File Organization Example**  
...
- Associated attachment: `[root]/laws/attachments/CO/CO_HAZCHEMICALDISPOSAL_20260504/CO_HAZCHEMICALDISPOSAL_20260504_ENVIRONMENTIMPACT.ods`
