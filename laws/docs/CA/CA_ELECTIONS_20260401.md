...
## Preamble
Elections in the Hudson Republic are sacred exercises of individual sovereignty, conducted with uncompromising integrity to prevent capture, fraud, or external influence. This Act ensures transparent, verifiable, in-person voting; bullion-exclusive financing aligned with sound-money principles (pursuant to the **Legal Tender Act** and the **Banking and Reserves Act**); strict personal accountability for interference; and mechanisms that prioritize citizen trust over convenience or partisan advantage. All electoral processes shall be fully auditable, continuously video-monitored, and subject to freedom-of-information access.
...
**1.4 Bullion Mandate**: All funding, donations, and fees must be settled exclusively in physical bullion per the **Legal Tender Act** and must adhere to the **Banking and Reserves Act**.  
...
## Section 2 — Election Day Procedures
**2.1 In-Person Only**: No mail-in, early, proxy, or vouching permitted.  
**2.2 Eligibility**: Citizens who have attained the Age of Majority.  
**2.3 Identification**: Republic-issued photo ID plus a personal **Voter ID Pass (VIP)**.  
...
**4.2 Application Fee**: Non-refundable **one-eighth (1/8) troy ounce of gold**.  
...
**9.1 Individuals**: Max one (1) troy ounce of gold per candidate.  
**9.2 Businesses**: Max ten (10) troy ounces of gold per campaign.  
...
## Section 11 — Supreme Court Justice Elections
**11.1** Twelve (12) Justice openings; maximum 50 candidates.  
**11.2 Selection**: Justices are elected by the **Senate** following a general election.

---

## Section 12 — By-elections
**12.1 Frequency**: Conducted every 24–30 months, or when triggered by the **Elected Officials and Integrity Act**.  
**12.2 Timing**: Campaign starts 15–30 days after the writ is issued.

---

## Section 13 — Personnel Requirements
**13.1 Status**: All election staff must be Hudson Republic citizens.  
**13.2 Residency**: Staff must have 2 years residency in the relevant Riding.  
**13.3 Integrity**: Clean criminal record required for all hires.

---

## Section 14 — Mass Vacancies and Emergency Elections
**14.1 Emergency Bi-elections**: Triggered by death, incapacitation, conviction, or conflict of interest of a Riding Representative, Senator, or Mediator.  
**14.2 Writ**: Issued within seven (7) days of the triggering event; polling within 60 days.  
**14.3 National Representative Vacancy**: If the National Representative is removed or incapacitated, a **General Election for all offices** is triggered immediately.  
**14.4 Mass Vacancy Threshold**: If ≥25% of seats in a particular house become vacant within any 7-day period, a general election for that house is called.

---

## Section 15 — Notice of Withdrawal (NOW)
**15.1 Procedure**:  
