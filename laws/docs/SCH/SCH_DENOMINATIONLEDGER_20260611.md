...
### Directory Structure
Receipts Path (Added): receipts/added/[Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp  
Receipts Path (Removed): receipts/removed/[Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp  
Receipts Path (Fraud): receipts/fraud/[Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp  
Receipts Path (Blacklisted): receipts/blacklist/[Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp  
Hudson (Beaver) Ledger Path: ledger/hudson_ledger_records_[Business Code]_[YYYYYYYYYYYY]YYYY.txt  
- NOTE: No hyphens (-) in filenames whatsoever.
...
Filename: [Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp  
...
- The script in the --remove option will utilize the same scraped metadata as [Business Code]_[Mint Year]_[Entry Address]_ADDED.hldp, but it will generate its own unique hash for all its entry(s) in the ledger and [Business Code]_[Mint Year]_[Entry Address]_REMOVED.hldp file.  
...
- This prompt asks you to confirm committing to the ledger and creating the associated [Business Code]_[Mint Year]_[Entry Address]_[ACTION].hldp file.  
...
- If the [Action Type], [Mint Year], [Entry Address] and [Transaction Amount] fields are all the same as the user's input from the script, then the entry will fail to be entered and produce an error.  
...
- With the -1 switch put "Comment: [Action Type]:[Entry Address] flagged for fraud inside the Hudson Republic" inside the [Business Code]_[Mint Year]_[Entry Address]_BLACKLISTED.hldp file.
- With the -5 switch put "Comment[1-5]: [Action Type]:[Entry Address] flagged for fraud inside the Hudson Republic" inside the [Business Code]_[Mint Year]_[Entry Address]_BLACKLISTED.hldp file.
